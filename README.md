...
codex plugin add yotta-present@yotta-present
```
...
- **Skill** — `yotta-present` skill instructions (`skills/yotta-present/SKILL.md`)
...
- The skill payload is copied from the source repository release; for full documentation see [YottaMeta/yotta-present](https://github.com/YottaMeta/yotta-present).

### Source

Upstream skill repository: [YottaMeta/yotta-present](https://github.com/YottaMeta/yotta-present)
Plugin repository: [YottaMeta/yotta-present-plugin](https://github.com/YottaMeta/yotta-present-plugin)
...
- **技能** — `yotta-present` 技能指令（`skills/yotta-present/SKILL.md`）
...
- 技能内容来自源仓库发布版；完整文档见 [YottaMeta/yotta-present](https://github.com/YottaMeta/yotta-present)。

### 来源

上游技能仓库：[YottaMeta/yotta-present](https://github.com/YottaMeta/yotta-present)
插件仓库：[YottaMeta/yotta-present-plugin](https://github.com/YottaMeta/yotta-present-plugin)
